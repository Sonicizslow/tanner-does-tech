          ...
          <main className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 px-8 py-5 leading-relaxed'>
            ...
            <div className='border border-gray-200 rounded-lg p-4'>
              <h3 className='font-extrabold'>Boring Weather</h3>
                  <p className='mt-2'>
                  Released in November of 2023, <a className='hover:text-blue-600 underline' target="_blank" rel='noopener noreferrer' href="https://apps.apple.com/us/app/boring-weather/id6464798240">Boring Weather</a> is an iOS app created to provide straightforward weather information. 
